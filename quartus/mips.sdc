...
create_clock -name "clock" -period 20.000ns -waveform {0.0 10.0}  [get_ports {clock}]
...
#set_clock_groups -exclusive -group {clock} -group {key(0)}

# Constrain the derived clock:
#create_generated_clock -add -source clock -divide_by 62500 -name CLK_400HZ  [get_pins {CLK_400HZ|q}]
